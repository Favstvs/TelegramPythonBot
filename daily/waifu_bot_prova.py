...
def daily(update: Update, context: CallbackContext):
    ...
    #Time_Mess = datetime.utcfromtimestamp(messageTime)
    ...
    date_1 = data[0]
    date_2 = '2023-05-06 23:54:20' #Time_Mess
    ...
    if diff_in_hours > 12:
        try:
    		...
    		#inserico la nuova data nella colonna apposita della tabella
                mycursors.execute("""UPDATE users SET Time_Mess=%s WHERE ID_User=%s""", (Time_Mess, ID_User,))
        except:
            pass
    else:

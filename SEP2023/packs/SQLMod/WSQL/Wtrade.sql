...
CREATE TABLE `Wtrade` (
  ...
  CONSTRAINT `scambio_ibfk_4` FOREIGN KEY (`Scambio_1`) REFERENCES `husbando` (`ID_Waifu`),
  CONSTRAINT `scambio_ibfk_5` FOREIGN KEY (`Scambio_2`) REFERENCES `husbando` (`ID_Waifu`)
) ENGINE=InnoDB;

    ...
    if data[0]:
        ...
        if protecc:
            ...
            if findWholeWord(protecc, Servant):
                ...
                context.bot.send_message(chat_id=ID_Supergruppo, text="✅ OwO <b>Hai protetto</b> " + original_Servant + " di " + nome_anime + ".\n"
...
def main():
    ...
    dp.add_handler(CommandHandler("harem", harem, Filters.group & Filters.update.message))

...
def help(update: Update, context: CallbackContext):
    update.message.reply_text(text="Aggiungi waifu al tuo harem con /protecc <i>nome del personaggio</i>\n"
                                   ...
                                   "/listservants per vedere il tuo harem\n"
                                   "/groupservants visualizza gli harem più grandi del gruppo\n"
    ...
    if data[0]:
        ...
        if protecc:
            ...
            if findWholeWord(protecc, Servant):
                ...
                context.bot.send_message(chat_id=ID_Supergroup, text="OwO <b>Hai protetto</b>" + original_Servant +
